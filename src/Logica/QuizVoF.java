...
public class QuizVoF extends Actividad{
	...
	public QuizVoF(String descripcion, String objetivo, String fechaLimite, int nivelDificultad, int duracionEsperada, boolean actividadCompletada, int nota, boolean disponible, boolean hecha, boolean calificada, boolean tienePrerequisito, boolean prerequisitoCumplido) {
